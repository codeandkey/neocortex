...
std::vector<Move>::iterator lookup::pawn_advances(u8 s, u8 col) {
    return _nc2_pawn_advance_table[s][col].begin();
}

std::vector<Move>::iterator lookup::pawn_captures(u8 s, u8 col) {
    return _nc2_pawn_capture_table[s][col].begin();
}
